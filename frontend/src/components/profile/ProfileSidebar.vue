    ...
    <div class="col-md-4">
        ...
        <div class="card p-2">
            <div class="d-flex justify-content-center align-items-center flex-column">
                <img :src="authStore.user?.profile_image" :alt="`Profile image of ${authStore.user.name}`" width="150"
                    height="150" class="rounded-circle object-fit-cover border border-2 border-secondary mt-1" />
                <div class="input-group pb-5 pt-4 w-75">
                    <input type="file" class="form-control" id="inputGroupFile04"
                        aria-describedby="inputGroupFileAddon04" aria-label="Upload" @change="handleFileInputChange"
                ...
                <ul class="list-group w-100 test-center mt-2">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <i class="bi bi-flag-fill">Country</i>
                        <span class="badge bg-dark rounded-pill">{{ authStore.user?.country || 'N/A' }}</span>
                    </li>
                    <li class="list-group-item">
                        <router-link to="/user/orders" class="text-decoration-none text-dark">
                            <i class="bi bi-bag-check-fill"></i> Orders || Purchases
                        </router-link>
                    </li>
                </ul>
            </div>
